...
- **ex2:**  
 Écrire une procédure appelée delay4s génére un délai de 4 secondes.    
 En utilsant cette procédure, Écrire un programme pour clignoter une LED (light emitting diode) connectée au port B de l'interface parallèle  8255 chaque 4 secondes.    
